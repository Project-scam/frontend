  ...
  function EndScreen({ gameWon, gameOverReason, guessesCount, secretCode, colors, onReset }) {
    ...
    return (
      <div className="board-bomb" style={{ padding: '40px 36px' }}>
        ...
        <h2 style={{ color: titleColor, fontFamily: 'Orbitron', fontSize: '28px',
        ...
        <div style={{
          ...
          <div
            style={{ color: '#eab308', textAlign: 'center', fontSize: '14px',
                     fontFamily: 'Orbitron, monospace', margin: "40px 0 8px 0"
            }} >
            Secret code:
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 64px)',
                        gap: '16px', justifyContent: 'center', margin: '20px 0',
                        padding: '12px 0',
            }} >
